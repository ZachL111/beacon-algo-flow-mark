"""Regression checks for the beacon-algo-flow-mark casebook."""
...
from casebook.harness import assert_expected, beacon_algo_flow_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_algo_flow_mark_summary(), assert_expected())
